...
class Render(VisBase):
    ...
    def _create_vertex_colors(self, num_vertices):
        ...
        color_map = {
            ...
            5: np.array([0.0, 1.0, 1.0]),      # R_Knee: option-Red [1.0, 0.0, 0.0]
            16: np.array([0.0, 1.0, 0.0]),     # L_Shoulder: Lime
            17: np.array([1.0, 0.0, 0.0]),     # R_Shoulder: Purple
            18: np.array([0.0, 1.0, 0.0]),   # L_Elbow: Navy [0.0, 0.0, 0.502]
            19: np.array([1.0, 0.0, 0.0])  # R_Elbow: Coral [1.0, 0.498, 0.314]
        }
